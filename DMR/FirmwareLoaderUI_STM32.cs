...
public class FirmwareLoaderUI_STM32 : Form
{
	...
	private void InitializeComponent()
	{
            ...
            this.lblWarning.Text = "При установке прошивки OpenGD77 RUS настоятельно рекомендуется в первый раз включ" +
    "ить рацию в режиме сброса (с зажатой SK2 на портативных моделях, с P3 на MD-9600" +
    ").";
