...
public class ChannelForm : DockContent, IDisp
{
	...
	public class Channel : IData
	{
		...
		public string Format => "Channel{0}";
	...
	private void InitializeComponent()
	{
		...
		base.SuspendLayout();
		this.tsrCh.Items.AddRange(new System.Windows.Forms.ToolStripItem[9] { this.tslblInfo, this.toolStripSeparator2, this.tsbtnFirst, this.tsbtnPrev, this.tsbtnNext, this.tsbtnLast, this.toolStripSeparator1, this.tsbtnAdd, this.tsbtnDel });
		...
		this.tsbtnFirst.Click += new System.EventHandler(tsbtnFirst_Click);
		...
		this.tsbtnPrev.Click += new System.EventHandler(tsbtnPrev_Click);
		...
		this.tsbtnNext.Click += new System.EventHandler(tsbtnNext_Click);
		...
		this.tsbtnLast.Click += new System.EventHandler(tsbtnLast_Click);
		...
		this.mnsCh.Items.AddRange(new System.Windows.Forms.ToolStripItem[1] { this.tsmiCh });
		...
		this.chkUseLocation.Size = new System.Drawing.Size(236, 20);
		this.chkUseLocation.TabIndex = 35;
		this.chkUseLocation.Text = "Use location";
		this.chkUseLocation.UseVisualStyleBackColor = true;
		this.chkUseLocation.CheckedChanged += new System.EventHandler(chkLocationValid_CheckedChanged);
		...
		this.chkRoaming.CheckedChanged += new System.EventHandler(chkRoaming_CheckedChanged);
		...
		this.nudTxColor.ValueChanged += new System.EventHandler(nudTxColor_ValueChanged);
		...
		this.cmbRxGroup.SelectedIndexChanged += new System.EventHandler(cmbRxGroup_SelectedIndexChanged);
		...
		this.cmbContact.SelectedIndexChanged += new System.EventHandler(cmbContact_SelectedIndexChanged);
		...
		this.chkDMRForceDMO.Location = new System.Drawing.Point(12, 85);
		this.chkDMRForceDMO.Name = "chkDMRForceDMO";
		this.chkDMRForceDMO.Size = new System.Drawing.Size(214, 20);
		this.chkDMRForceDMO.TabIndex = 35;
		this.chkDMRForceDMO.Text = "Force DMO";
		this.chkDMRForceDMO.UseVisualStyleBackColor = true;
		this.chkDMRForceDMO.CheckedChanged += new System.EventHandler(chkDMRForceDMO_CheckedChanged);
		...
		this.chkRxOnly.Location = new System.Drawing.Point(796, 63);
		...
		this.chkRxOnly.CheckedChanged += new System.EventHandler(chkRxOnly_CheckedChanged);
		...
		this.cmbRxTone.KeyDown += new System.Windows.Forms.KeyEventHandler(cmbRxTone_KeyDown);
		this.cmbRxTone.Validating += new System.ComponentModel.CancelEventHandler(cmbRxTone_Validating);
		...
		this.cmbAPRS_System.SelectedIndexChanged += new System.EventHandler(cmbAPRS_SelectedIndexChanged);
		...
		this.cmbTxTone.SelectedIndexChanged += new System.EventHandler(cmbTxTone_SelectedIndexChanged);
		this.cmbTxTone.KeyDown += new System.Windows.Forms.KeyEventHandler(cmbTxTone_KeyDown);
		this.cmbTxTone.Validating += new System.ComponentModel.CancelEventHandler(cmbTxTone_Validating);
		...
		this.chkVox.Location = new System.Drawing.Point(796, 44);
		...
		this.chkNoBeep.Location = new System.Drawing.Point(796, 82);
		...
		this.chkNoBeep.CheckedChanged += new System.EventHandler(chkNoBeep_CheckedChanged);
		this.chkNoEco.AccessibleDescription = "No Economy";
		this.chkNoEco.AccessibleName = "No Economy";
		this.chkNoEco.Location = new System.Drawing.Point(796, 101);
		...
		this.chkNoEco.CheckedChanged += new System.EventHandler(chkNoEco_CheckedChanged);
		...
		this.cmbChMode.SelectedIndexChanged += new System.EventHandler(cmbChMode_SelectedIndexChanged);
		...
		this.txtTxFreq.Location = new System.Drawing.Point(663, 26);
		this.txtTxFreq.Name = "txtTxFreq";
		this.txtTxFreq.Size = new System.Drawing.Size(119, 23);
		this.txtTxFreq.TabIndex = 4;
		this.txtTxFreq.Validating += new System.ComponentModel.CancelEventHandler(txtTxFreq_Validating);
		...
		this.lblTot.Location = new System.Drawing.Point(520, 58);
		...
		this.txtRxFreq.Validating += new System.ComponentModel.CancelEventHandler(txtRxFreq_Validating);
		...
		this.lblTxFreq.Location = new System.Drawing.Point(520, 26);
		...
		this.nudTot.Location = new System.Drawing.Point(663, 58);
		this.nudTot.Name = "nudTot";
		this.nudTot.Size = new System.Drawing.Size(120, 23);
		this.nudTot.TabIndex = 12;
		this.nudTot.Value = new decimal(new int[4] { 50, 0, 0, 0 });
		this.nudTot.ValueChanged += new System.EventHandler(nudTot_ValueChanged);
		base.ClientSize = new System.Drawing.Size(1104, 419);
		...
		this.Text = "Channel";
		base.FormClosing += new System.Windows.Forms.FormClosingEventHandler(ChannelForm_FormClosing);
		base.Load += new System.EventHandler(ChannelForm_Load);
		base.Shown += new System.EventHandler(ChannelForm_Shown);
	...
	static ChannelForm()
	{
		...
		SZ_TA_TX = new string[4] { "Off", "APRS", "Text", "APRS & Text" };
