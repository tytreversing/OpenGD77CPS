...
public class FirmwareLoaderUI_STM32 : Form
{
	...
	private void InitializeComponent()
	{
            ...
            this.lblWarning.Text = "После первой установки прошивки ОБЯЗАТЕЛЬНО записать в рацию пустой кодплаг, и то" +
    "лько затем что-то редактировать. Не пытайтесь сразу считывать данные из рации.";
