...
public class BootItemForm : DockContent, IDisp
{
	...
	private void InitializeComponent()
	{
		...
		this.chkBootPwdEnable.CheckedChanged += new System.EventHandler(chkBootPwdEnable_CheckedChanged);
		...
		this.cmbBootScreen.SelectedIndexChanged += new System.EventHandler(cmbBootScreen_SelectedIndexChanged);
		...
		this.txtLine2.Leave += new System.EventHandler(txtLine2_Leave);
		...
		this.txtLine1.Leave += new System.EventHandler(txtLine1_Leave);
		...
		base.ClientSize = new System.Drawing.Size(350, 262);
		...
		this.Text = "Boot Item";
		base.FormClosing += new System.Windows.Forms.FormClosingEventHandler(BootItemForm_FormClosing);
		base.Load += new System.EventHandler(BootItemForm_Load);
